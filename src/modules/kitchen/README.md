...
- `POST /api/v1/kitchen/station-tickets/:stationTicketId/status`: avanza el ticket validando transiciones (`PENDING -> IN_PROGRESS`, `IN_PROGRESS -> READY`, cancelacion solo para `ADMIN`/`SUPERVISOR`)
